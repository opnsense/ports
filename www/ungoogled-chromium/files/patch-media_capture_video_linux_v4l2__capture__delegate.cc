--- media/capture/video/linux/v4l2_capture_delegate.cc.orig	2026-04-15 11:25:12 UTC
...
+
 ...
 namespace {
@@ -270,7 +282,7 @@ bool V4L2CaptureDelegate::IsBlockedControl(int control
 // static
...
@@ -453,7 +465,7 @@ void V4L2CaptureDelegate::AllocateAndStart(
...
@@ -797,7 +809,7 @@ base::WeakPtr<V4L2CaptureDelegate> V4L2CaptureDelegate
...
@@ -1096,6 +1115,7 @@ void V4L2CaptureDelegate::DoCapture() {
...
@@ -1149,7 +1169,7 @@ void V4L2CaptureDelegate::DoCapture() {
       // workable on Linux.
