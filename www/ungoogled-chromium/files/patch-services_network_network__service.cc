--- services/network/network_service.cc.orig	2026-04-15 11:25:12 UTC
...
@@ -1028,7 +1028,7 @@ void NetworkService::SetExplicitlyAllowedPorts(
...
@@ -1168,7 +1168,7 @@ NetworkService::CreateHttpAuthHandlerFactory(NetworkCo
   );
 }
