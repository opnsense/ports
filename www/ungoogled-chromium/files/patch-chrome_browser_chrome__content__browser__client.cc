--- chrome/browser/chrome_content_browser_client.cc.orig	2026-04-15 11:25:12 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -1490,7 +1490,7 @@ void ChromeContentBrowserClient::RegisterLocalStatePre
...
@@ -1755,7 +1755,7 @@ ChromeContentBrowserClient::GetStoragePartitionConfigF
...
@@ -2648,7 +2648,7 @@ bool ChromeContentBrowserClient::ShouldUrlUseApplicati
     const GURL& url) {
 #if BUILDFLAG(ENABLE_EXTENSIONS)
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || \
-    BUILDFLAG(IS_CHROMEOS)
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (!content::AreIsolatedWebAppsEnabled(browser_context)) {
     return false;
@@ -2776,7 +2776,9 @@ void MaybeAppendBlinkSettingsSwitchForFieldTrial(
...
@@ -2785,7 +2787,7 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
...
@@ -4175,7 +4177,7 @@ GetPreferredColorScheme(const WebPreferences& web_pref
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -5119,7 +5121,7 @@ void ChromeContentBrowserClient::GetAdditionalAllowedS
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) ||
         // BUILDFLAG(IS_CHROMEOS)
@@ -5173,7 +5175,7 @@ void ChromeContentBrowserClient::GetAdditionalFileSyst
   }
 }
...
+#if BUILDFLAG(IS_POSIX) && !BUILDFLAG(IS_MAC) && !BUILDFLAG(IS_BSD)
 void ChromeContentBrowserClient::GetAdditionalMappedFilesForChildProcess(
     ...
     int child_process_id,
@@ -6071,7 +6073,7 @@ ChromeContentBrowserClient::CreateNonNetworkNavigation
   }
 #endif  // BUILDFLAG(IS_CHROMEOS)
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || \
-    BUILDFLAG(IS_CHROMEOS)
...
@@ -6097,7 +6099,7 @@ void ChromeContentBrowserClient::
   DCHECK(factories);
...
@@ -6126,7 +6128,7 @@ void ChromeContentBrowserClient::
   DCHECK(factories);
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   if (content::AreIsolatedWebAppsEnabled(browser_context) &&
       !browser_context->ShutdownStarted()) {
     factories->emplace(webapps::kIsolatedAppScheme,
@@ -6398,7 +6400,7 @@ void ChromeContentBrowserClient::
 #endif  // BUILDFLAG(IS_CHROMEOS)
...
@@ -7005,7 +7007,7 @@ bool ChromeContentBrowserClient::HandleExternalProtoco
...
@@ -7134,7 +7136,7 @@ bool ChromeContentBrowserClient::HandleWebUI(
   }
...
@@ -7413,7 +7415,7 @@ bool ChromeContentBrowserClient::ShouldSandboxNetworkS
...
@@ -7869,7 +7871,7 @@ void ChromeContentBrowserClient::
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   // default.
@@ -8307,7 +8309,7 @@ ChromeContentBrowserClient::GetAlternativeErrorPageOve
