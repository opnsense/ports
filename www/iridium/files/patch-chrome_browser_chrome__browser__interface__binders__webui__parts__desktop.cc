--- chrome/browser/chrome_browser_interface_binders_webui_parts_desktop.cc.orig	2026-04-15 12:07:04 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX)
       NewTabPageUI>(map);
@@ -571,7 +571,7 @@ void PopulateChromeWebUIFrameBindersPartsDesktop(
         OmniboxPopupUI>(map);
   }
...
@@ -601,7 +601,7 @@ void PopulateChromeWebUIFrameBindersPartsDesktop(
