--- chrome/browser/page_load_metrics/page_load_metrics_initialize.cc.orig	2026-04-09 06:05:42 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -352,7 +352,7 @@ bool PageLoadMetricsEmbedder::IsInternalWebUI(const GU
