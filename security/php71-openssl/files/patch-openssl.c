--- openssl.c.orig	2017-06-07 08:09:36 UTC
+++ openssl.c
@@ -18,6 +18,7 @@
...
+#include <openssl/ocsp.h>
 ...
 /* Common */
 #include <time.h>
@@ -132,6 +134,56 @@ PHP_FUNCTION(openssl_dh_compute_key);
...
@@ -482,12 +534,20 @@ const zend_function_entry openssl_functi
...
@@ -729,6 +789,7 @@ void php_openssl_store_errors()
 static int le_key;
 static int le_x509;
 static int le_csr;
+static int le_crl;
...
@@ -737,6 +798,16 @@ int php_openssl_get_x509_list_id(void) /
 }
 /* }}} */
...
+
 ...
 {
@@ -758,6 +829,21 @@ static void php_csr_free(zend_resource *
...
@@ -1401,6 +1487,7 @@ PHP_MINIT_FUNCTION(openssl)
...
@@ -1497,6 +1584,36 @@ PHP_MINIT_FUNCTION(openssl)
...
+static int check_cert(X509_STORE *ctx, X509 *x, STACK_OF(X509) *untrustedchain, int purpose, long flags)
 {
 	int ret=0;
 	X509_STORE_CTX *csc;
@@ -2507,6 +2624,9 @@ static int check_cert(X509_STORE *ctx, X
...
@@ -2520,6 +2640,59 @@ static int check_cert(X509_STORE *ctx, X
 }
 /* }}} */
...
@@ -2556,7 +2729,7 @@ PHP_FUNCTION(openssl_x509_checkpurpose)
 		goto clean_exit;
 	}
...
@@ -6633,6 +6806,442 @@ PHP_FUNCTION(openssl_random_pseudo_bytes
 }
 /* }}} */
