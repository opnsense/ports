--- src/slic3r/GUI/Plater.cpp.orig	2026-05-19 09:09:17 UTC
...
+#include <libnanosvg/nanosvgrast.h>
 ...
 #include <vector>
 #include <string>
@@ -974,7 +974,7 @@ void Plater::priv::init()
...
@@ -1327,7 +1327,7 @@ std::vector<size_t> Plater::priv::load_files(const std
...
+#if defined(__linux__) || defined(__FreeBSD__)
 ...
 #else
@@ -1399,7 +1399,7 @@ std::vector<size_t> Plater::priv::load_files(const std
         Slic3r::Model model;
...
@@ -3643,7 +3643,7 @@ void Plater::priv::on_right_click(RBtnEvent& evt)
...
@@ -4516,7 +4516,7 @@ void Plater::load_project(const wxString& filename)
