--- src/slic3r/GUI/ConfigWizard.cpp.orig	2026-05-19 09:09:17 UTC
...
@@ -1676,7 +1676,7 @@ PageDownloader::PageDownloader(ConfigWizard* parent)
         ));
     }
...
@@ -1694,7 +1694,7 @@ bool PageDownloader::on_finish_downloader() const
...
@@ -1743,10 +1743,10 @@ bool DownloaderUtils::Worker::perform_url_register()
     }
...
+#elif (defined(__linux__) || defined(__FreeBSD__)) && defined(SLIC3R_DESKTOP_INTEGRATION
 ...
 #endif
@@ -1762,9 +1762,9 @@ void DownloaderUtils::Worker::deregister()
         return;
     }
     key_full = key_string;
-#elif __APPLE__
...
@@ -3407,7 +3407,7 @@ bool ConfigWizard::priv::apply_config(AppConfig *app_c
